...
- `git clone https://github.com/UniversalPropositions/UP_Marathi-UFAL.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Marathi-UFAL>/ --input_up=<up_path_to_UP_Marathi-UFAL>/ --output=<path_to_UD+UP_Marathi-UFAL>/`
